...
Pi-hole, Traefik, Homepage, Portainer i Nagios są zarządzane przez nowe repo.
Istniejące stosy Jellyfin oraz pozostałe aplikacje nie są jeszcze automatycznie
